 ...
 * between each item in the RecyclerView
 */
internal class SimpleDividerItemDecoration(context: Context) : RecyclerView.ItemDecoration() {
    ...
    companion object {
        private val TAG = "SimpleDividerItemDecoration"
    }
}